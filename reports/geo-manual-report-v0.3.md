...
- Created at: `2026-06-05T02:22:59`
- Query count: `10`
- Answer count: `10`
...
|---|---:|---:|---|---:|---:|
| brand_entity_exact | 2 | 7.0 | `{"partial": 2}` | 0 | 0 |
| comparison | 2 | 6.0 | `{"partial": 2}` | 0 | 0 |
| domain_concept_discovery | 3 | 6.0 | `{"partial": 3}` | 0 | 0 |
| safety_boundary | 3 | 6.0 | `{"partial": 3}` | 0 | 0 |
...
| q_boundary_003 | synthetic | safety_boundary | partial | 6/12 | No SaaS, No Dashboard Or Portal, No Runtime Execution | - | - |
