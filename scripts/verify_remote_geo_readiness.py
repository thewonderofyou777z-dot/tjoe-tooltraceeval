...
REQUIRED_TEXT_MARKERS = {
    ...
    "docs/answers.html": ["TjoeReviewKit 标准问答", "如果没有可靠公开来源"],
    "README.md": ["English summary", "v0.3.8-index-entrypoint-enhancement"],
    "llms.txt": ["TjoeReviewKit", "standard answers page"],
